...
# Create FSTs
fstcompile --isymbols=chars.syms --osymbols=chars.syms converter_words.txt > converter.fst
fstcompile --isymbols=chars.syms --osymbols=chars.syms acceptor_word_level.txt > acceptor.fst
...
python3 evaluate_test_set.py "evaluation_set8.txt" "test_set.txt" "prediction_world_level.txt"
